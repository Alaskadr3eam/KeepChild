...
var profil1 = Profile(id: "123", idUser: user1.senderId, name: "numero1", firstName: "1", pseudo: "test1", mail: user1.email, phone: "1111111111", postalCode: "34570", city: "murviel-les-montpellier")
var profil2 = Profile(id: nil, idUser: user2.senderId, name: "numero2", firstName: "2", pseudo: "test2", mail: user2.email, phone: "2222222222", postalCode: "34570", city: "montarnaud")
...
let announce1 = Announce(id: "1", idUser: user1.senderId, title: "announce1", description: "announce1Description", price: "price1", semaine: semaine1, coordinate: coordinate1, phone: true, day: true, night: false)
let announce2 = Announce(id: "2", idUser: user2.senderId, title: "announce2", description: "announce2Description", price: "price2", semaine: semaine2, coordinate: coordinate2, phone: false, day: false, night: true)
...
let conversation1 = Conversation(id: "123", idAnnounce: "1", name: "test", idUser1: user1.senderId, idUser2: user2.senderId, arrayMessage: [message2.representation])
